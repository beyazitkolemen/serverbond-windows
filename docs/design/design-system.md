...
- **Hizmetler:** sol kenar çubuğunda ızgara kartları. Hizmete girince kurulum ve çalıştırma; port ve jeton **Ayarlar** düğmesindedir. Onarım ayrı karttır: tanı, korunan yollar ve onay penceresi.
