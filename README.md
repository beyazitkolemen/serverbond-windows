...
Son yayımlanan sürüm **v1.3.11**'dir. Bu sürüm elle kurulur ve imzalı otomatik güncelleme paketi içermez. Ekran görüntüleri v1.3.0 arayüzünün örnek verili, salt okunur önizlemesidir. [Sürüm notları](docs/releases/v1.3.11.md) · [Güncellemeler](docs/updates.md).
