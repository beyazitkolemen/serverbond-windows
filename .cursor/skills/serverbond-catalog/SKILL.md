...
Kaynak: `crates/serverbond-core/catalog.json`, `crates/serverbond-core/php-versions.json`, `crates/serverbond-core/tools.json` (isteğe bağlı araçlar; ortamı bloke etmez), [docs/packages.md](../../../docs/packages.md).
...
| Redis | GitHub `redis-windows` 8.10.2 MSYS2 ZIP `digest` / yayımlanan SHA-256 |
