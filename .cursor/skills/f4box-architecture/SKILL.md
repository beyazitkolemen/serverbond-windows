...
Varsayılan `%LOCALAPPDATA%\ServerBond` (eski kurulum `%LOCALAPPDATA%\F4Box` ise o kullanılır). Geliştirmede `SERVERBOND_HOME` veya `F4BOX_HOME`. İkinci süreç `manager.lock` ile reddedilir.
