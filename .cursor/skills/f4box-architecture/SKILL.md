...
Yeni iş kuralı çekirdeğe yazılır, masaüstünde yalnızca komut dışa aktarılır, arayüz `snapshot` okur. Yerel sürüm tarifi `release.rs` + `Project.release`; uzak SSH yoktur.
