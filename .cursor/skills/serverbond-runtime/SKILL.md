...
Giriş noktası `Manager` (`crates/serverbond-core/src/lib.rs`). Uzun işlemler `gate()` ile tekil; panik `contain()` ile yakalanır ve `faulted` yeni yazmayı kilitler.
